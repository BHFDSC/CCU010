...
spark.sql(f"""
  ...
  auth_county as (
    ...
    FROM lsoa_auth
    LEFT JOIN .ons_chd_geo_listings e10 on e10.geography_code = lsoa_auth.authority_parent_geography
  ...
  lsoa_region as (
    ...
    LEFT JOIN .ons_chd_geo_listings e12 on lsoa_region_code.region_code = e12.geography_code
  )
